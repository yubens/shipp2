...
public class CargaDevolucionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder dialogo = new AlertDialog.Builder(CargaDevolucionActivity.this);
                                        ...
                                        public void run() {
                                            ...
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    if (res) {
                                                        Limpiar("todo");
                                                        Toast toastEnviar = Toast.makeText(CargaDevolucionActivity.this, R.string.mensajeInsercionOK, Toast.LENGTH_LONG);
                                                        toastEnviar.show();
                                                        finish();
                                                    }
                                                }
