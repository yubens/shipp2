package ar.com.idus.www.idusappshiping.signature;
...
public class SignatureMainLayout extends LinearLayout implements OnClickListener {
    ...
    public SignatureMainLayout(Context context, Comprobante comprobante) {
        super(context);
        comp = comprobante;
    ...
    private LinearLayout buttonsLayout() {
        ...
        Button exitBtn = new Button(this.getContext());
        ...
        saveBtn.setText("Grabar Firma");
        saveBtn.setTag("Grabar Firma");
        saveBtn.setOnClickListener(this);

        clearBtn.setText("Limpiar");
        clearBtn.setTag("Limpiar");
        clearBtn.setOnClickListener(this);

        exitBtn.setText("Cancelar");
        exitBtn.setTag("Cancelar");
    ...
    public void onClick(View v) {
        ...
        // save the signature
        if (tag.equalsIgnoreCase("Grabar Firma")) {
            this.saveImage(this.signatureView.getSignature());
        } else if (tag.equalsIgnoreCase("Limpiar")) {
            this.signatureView.clearSignature();
        } else if (tag.equalsIgnoreCase("Cancelar")) {
    ...
    final void saveImage(Bitmap signature) {
        ...
        String fname = comp.getId().toString() + ".png";
        ...
        try {
            ...
            Toast.makeText(this.getContext(), "Firma Guardada Correctamente!!!.", Toast.LENGTH_LONG).show();
            Activity act = (Activity) this.getContext();
            act.finish();
        } catch (Exception e) {
            e.printStackTrace();
