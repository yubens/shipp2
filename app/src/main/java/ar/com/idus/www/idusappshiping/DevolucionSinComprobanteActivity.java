...
public class DevolucionSinComprobanteActivity extends AppCompatActivity {
    ...
    String _idEmpresa, _idVendedor, _codCliente, _strURL, _idCliente, _nombreCliente, _idFletero, _domicilioCliente;
    int _caja, _planilla;
    ...
    List<ComprobanteItem> listaItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devolucion_sin_comprobante);

        _strURL = "http://idus-express-return.dnsalias.com/webserviceidusexpress";
        //_strURL = "http://idus-express-shiping.dnsalias.com/WebServiceIdusShiping";
        ...
        Thread tr01 = new Thread() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if(resultado.equals("[]")){
                            Toast.makeText(getApplicationContext(), "Se produjo un error al buscar los datos del cliente",
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (resul02.equals("[]")) {
                                    ...
                                    //item = procesarBusquedaPorCodigo2(resul02);
            ...
            public void onClick(View v) {
                ...
                if(!butAgregar.isActivated()){
                    ...
                    try {
                        ...
                        //**********************
                        //**********************
                        // verificar que queden cargados los articulos con su cantidad y todo

                        //***** ver si conviene ir agregando comprobanteItems con los datos del articulo
                                        ...
                                        Thread trArt = new Thread() {
                                            ...
                                            public void run() {
                                                final String texto = "Art: " + articulo.getCodigo() + " - " + articulo.getNombre() + " \n" +
                                                        "Cant: " + ediCantidad.getText().toString() +
                                                        " - Precio Unitario: $" + df.format(_precioOriginal) + " \n" +
        ...
        listaItem.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder dialogo = new AlertDialog.Builder(DevolucionSinComprobanteActivity.this);
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Thread thread = new Thread() {
                                        ...
                                        public void run() {
                                            ...
                                            final boolean res = Devoluciones.insertarDevolucion(_idEmpresa, _idVendedor, _idCliente, _idFletero,
                                                                                                _total, _caja, _planilla, articulos);
                                            runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    String msj;
                                                    ...
                                                    Toast.makeText(DevolucionSinComprobanteActivity.this, msj, Toast.LENGTH_LONG).show();
                                                    finish();
                                                }
                                            });
                                        }
